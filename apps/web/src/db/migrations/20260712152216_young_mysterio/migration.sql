ALTER TABLE `apps` ADD `public_id` text;--> statement-breakpoint
UPDATE `apps` SET `public_id` = lower(substr(replace(`id`, '-', ''), 23, 10)) WHERE `public_id` IS NULL;--> statement-breakpoint
...
INSERT INTO `__new_apps`(`id`, `public_id`, `slug`, `name`, `author`, `contact_email`, `description`, `launch_url`, `listing_type`, `primary_category_id`, `secondary_category_id`, `target_device`, `status`, `submitted_by_user_id`, `reviewer_notes`, `submitted_at`, `reviewed_at`, `published_at`, `launch_count`, `created_at`, `updated_at`) SELECT `id`, `public_id`, `slug`, `name`, `author`, `contact_email`, `description`, `launch_url`, `listing_type`, `primary_category_id`, `secondary_category_id`, `target_device`, `status`, `submitted_by_user_id`, `reviewer_notes`, `submitted_at`, `reviewed_at`, `published_at`, `launch_count`, `created_at`, `updated_at` FROM `apps`;--> statement-breakpoint
